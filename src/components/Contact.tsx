          ...
          <div className="lg:pl-8">
            <div className="bg-gradient-to-br from-blue-600 to-purple-700 rounded-lg p-8 text-white">
              ...
              <p className="text-blue-100 mb-8">
                We're here to help you succeed. Reach out to us through any of the channels below or fill out the form to get started.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-blue-100">hello@businesspro.com</p>
                  </div>
                </div>
